...
namespace Sqlx {
    ...
    class Driver {
         ...
         */
        public function queryDictionary(string $query, ?array $parameters): array {}
         ...
         * - The iteration order of the returned map is **not** guaranteed.
         */
        public function queryDictionaryAssoc(string $query, ?array $parameters): array {}
         ...
         * - The iteration order of the returned map is **not** guaranteed.
         */
        public function queryDictionaryObj(string $query, ?array $parameters): array {}

        /**
         * Executes a SQL query and returns a dictionary grouping rows by the first column.
         *
         * Each row is grouped by its first column (used as a string key) and converted into a PHP array or object
         * depending on the driver’s current configuration (`OPT_ASSOC_ARRAYS`).
         *
         * # Errors
         * - If the first column is not convertible to string.
         * - If any row fails to convert to a PHP value.
         */
        public function queryGroupedDictionary(string $query, ?array $parameters): array {}
         ...
         */
        public function queryGroupedDictionaryAssoc(string $query, ?array $parameters): array {}
         ...
         */
        public function queryGroupedDictionaryObj(string $query, ?array $parameters): array {}
         ...
         */
        public function queryColumnDictionary(string $query, ?array $parameters): array {}
         ...
         */
        public function queryColumnDictionaryAssoc(string $query, ?array $parameters): array {}
         ...
         * Same as `query_column_dictionary`.
         */
        public function queryColumnDictionaryObj(string $query, ?array $parameters): array {}
    ...
    class PreparedQuery {
         ...
         * - The query must return at least two columns per row.
         */
        public function queryColumnDictionary(?array $parameters): array {}
         ...
         * Same as `query_column_dictionary`.
         */
        public function queryColumnDictionaryAssoc(?array $parameters): array {}
         ...
         * Same as `query_column_dictionary`.
         */
        public function queryColumnDictionaryObj(?array $parameters): array {}
         ...
         * - The iteration order of the returned map is **not** guaranteed.
         */
        public function queryDictionary(?array $parameters): array {}
         ...
         * - The iteration order of the returned map is **not** guaranteed.
         */
        public function queryDictionaryAssoc(?array $parameters): array {}
         ...
         * - The iteration order of the returned map is **not** guaranteed.
         */
        public function queryDictionaryObj(?array $parameters): array {}
         ...
         */
        public function queryGroupedDictionary(?array $parameters): array {}

        /**
         * Same as `query_grouped_dictionary`, but forces rows to be decoded as associative arrays.
         */
        public function queryGroupedDictionaryAssoc(?array $parameters): array {}

        /**
         * Same as `query_grouped_dictionary`, but forces rows to be decoded as PHP objects.
         */
        public function queryGroupedDictionaryObj(?array $parameters): array {}

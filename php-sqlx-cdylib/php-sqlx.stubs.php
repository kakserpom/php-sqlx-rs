...
namespace Sqlx {
    class SelectClause {
         ...
         */
        public function apply(array $fields): object {}
    ...
    class ByClause {
         ...
         * __invoke magic for apply()
         */
        public function __invoke(array $fields): object {}
    ...
    class PaginateClause {
         ...
         * __invoke magic for apply()
         */
        public function __invoke(?int $page_number, ?int $per_page): object {}
        ...
        public function apply(?int $page_number, ?int $per_page): object {}
